...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BIqEe97N.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CJQQYrrH.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DVD495Ii.js', import.meta.url).href),import:true},'antd':{get:()=>()=>__federation_import(new URL('__federation_shared_antd-BCPuyMa3.js', import.meta.url).href),import:true},'i18next':{get:()=>()=>__federation_import(new URL('__federation_shared_i18next-IGcJqHLj.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-DPNrtpXM.js', import.meta.url).href),import:true},'typescript':{get:()=>()=>__federation_import(new URL('__federation_shared_typescript-BtsqL7k5.js', import.meta.url).href),import:true}};
